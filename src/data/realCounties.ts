// 华夏地名舆地大典：全国地级市/直辖市区县级行政区划真实数据映射表
export const REAL_COUNTIES_MAP: { [key: string]: string[] } = {
  // === 直辖市的区（不设下辖区县，直接返回空数组，隐藏下级区划选项） ===
  ...
  "和平区": [], "河东区": [], "河西区": [], "南开区": [], "河北区": [], "红桥区": [], "东丽区": [], "西青区": [], "津南区": [], "北辰区": [], "武清区": [], "宝坻区": [], "宁河区": [], "静海区": [], "蓟州区": [],
  "万州区": [], "涪陵区": [], "渝中区": [], "大渡口区": [], "江北区": [], "沙坪坝区": [], "九龙坡区": [], "南岸区": [], "北碚区": [], "渝北区": [], "巴南区": [], "长寿区": [], "江津区": [], "合川区": [], "永川区": [], "南川区": [], "綦江区": [], "大足区": [], "璧山区": [], "铜梁区": [], "潼南区": [], "荣昌区": [], "开州区": [], "梁平区": [], "武隆区": [],
  ...
  "深圳市": ["福田区", "罗湖区", "盐田区", "南山区", "宝安区", "龙岗区", "龙华区", "坪山区", "光明区", "大鹏新区", "深汕特别合作区"],
  "珠海市": ["香洲区", "斗门区", "金湾区"],
  ...
  "东莞市": ["莞城区", "南城街道", "东城街道", "万江街道", "虎门镇", "长安镇", "常平镇", "厚街镇", "塘厦镇"],
  "中山市": ["石岐街道", "东区街道", "西区街道", "南区街道", "五桂山街道", "火炬开发区", "小榄镇", "三乡镇"],
  "潮州市": ["湘桥区", "潮安区", "饶平县"],
  ...
  "泸州市": ["江阳区", "纳溪区", "龙马潭区", "叙永县", "古蔺县", "合江县", "泸县"],
  "德阳市": ["旌阳区", "罗江区", "中江县", "广汉市", "什邡市", "绵竹市"],
  "绵阳市": ["涪城区", "游仙区", "安州区", "三台县", "盐亭县", "梓潼县", "平武县", "北川羌族自治县", "江油市"],
  ...
  "咸阳市": ["秦都区", "杨陵区", "渭城区", "三原县", "泾阳县", "乾县", "礼泉县", "永寿县", "彬州市", "长武县", "旬邑县", "淳化县", "武功县", "兴平市"],
  ...
  "宜昌市": ["西陵区", "伍家岗区", "点军区", "猇亭区", "夷陵区", "远安县", "兴山县", "秭归县", "宜都市", "当阳市", "枝江市"],
  ...
  // === 云南省 ===
  "昆明市": ["五华区", "盘龙区", "官渡区", "西山区", "东川区", "呈贡区", "晋宁区", "富民县", "宜良县", "石林彝族自治县", "嵩明县", "安宁市"],
  ...
  "普洱市": ["思茅区", "宁洱哈尼族自治县", "墨江哈尼族自治县", "景东彝族自治县", "景谷傣族彝族自治县"],
  "临沧市": ["临翔区", "凤庆县", "云县", "永德县", "镇康县", "沧源佤族自治县"],
  "楚雄彝族自治州": ["楚雄市", "双柏县", "牟定县", "南华县", "姚安县", "大姚县", "禄丰市"],
  "红河哈尼族彝族自治州": ["个旧市", "开远市", "蒙自市", "弥勒市", "建水县", "石屏县", "泸西县", "元阳县", "红河县"],
  "文山壮族苗族自治州": ["文山市", "砚山县", "西畴县", "麻栗坡县", "马关县", "丘北县", "广南县", "富宁县"],
  "西双版纳傣族自治州": ["景洪市", "勐海县", "勐腊县"],
  "大理白族自治州": ["大理市", "漾濞彝族自治县", "祥云县", "宾川县", "弥渡县", "巍山彝族回族自治县", "洱源县", "剑川县", "鹤庆县"],
  "德宏傣族景颇族自治州": ["瑞丽市", "芒市", "梁河县", "盈江县", "陇川县"],
  "怒江傈僳族自治州": ["电水市", "福贡县", "贡山独龙族怒族自治县", "兰坪白族普米族自治县"],
  ...
  "上饶市": ["信州区", "广丰区", "广信区", "玉山县", "铅山县", "横峰县", "弋阳县", "余干县", "万年县", "婺源县", "鄱阳县", "德兴市"],
  ...
  "安阳市": ["文峰区", "北关区", "殷都区", "龙安区", "安阳县", "内黄县", "滑县", "林州市"],
  ...
  "济源市": ["沁园街道", "济水街道", "北海街道", "天坛街道"],

  // === 河北省 ===
  "石家庄市": ["长安区", "桥西区", "新华区", "井陉矿区", "裕华区", "藁城区", "鹿泉区", "栾城区", "正定县", "平山县", "赵县", "晋州市", "新乐市"],
  "唐山市": ["路南区", "路北区", "古冶区", "开平区", "丰南区", "丰润区", "曹妃甸区", "滦南县", "乐亭县", "迁西县", "玉田县", "遵化市", "迁安市", "滦州市"],
  "秦皇岛市": ["海港区", "山海关区", "北戴河区", "抚宁区", "青龙满族自治县", "昌黎县", "卢龙县"],
  "邯郸市": ["邯山区", "丛台区", "复兴区", "峰峰矿区", "肥乡区", "永年区", "临漳县", "成安县", "大名县", "涉县", "磁县", "邱县", "鸡泽县", "广平县", "馆陶县", "魏县", "武安市"],
  "邢台市": ["襄都区", "信都区", "沙河市", "南宫市", "临城县", "内丘县", "柏乡县", "隆尧县", "任泽区", "南和区", "巨鹿县", "新河县", "广宗县", "平乡县", "威县", "清河县", "临西县"],
  "保定市": ["竞秀区", "莲池区", "满城区", "清苑区", "徐水区", "涞水县", "阜平县", "定兴县", "唐县", "涞源县", "望都县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县", "涿州市", "定州市", "安国市", "高碑店市"],
  ...
  "阳泉市": ["城区", "矿区", "郊区", "平定县", "盂县"],
  "长治市": ["潞州区", "屯留区", "潞城区", "上党区", "襄垣县", "平顺县", "黎城县", "壶关县", "长子县", "武乡县", "沁县", "沁源县"],
  "晋城市": ["城区", "沁水县", "阳城县", "陵川县", "泽州县", "高平市"],
  "朔州市": ["朔城区", "平鲁区", "山阴县", "应县", "右玉县", "怀仁市"],
  "晋中市": ["榆次区", "榆社县", "左权县", "和顺县", "昔阳县", "寿阳县", "太谷区", "祁县", "平遥县", "介休市", "灵石县"],
  ...
  "哈尔滨市": ["道里区", "南岗区", "道外区", "平房区", "松北区", "香坊区", "呼兰区", "阿城区", "双城区", "依兰县", "方正县", "宾县", "巴彦县", "尚志市", "五常市"],
  "南宁市": ["兴宁区", "江南区", "青秀区", "西乡塘区", "邕宁区", "良庆区", "武鸣区", "隆安县", "马山县", "上林县", "宾阳县", "横州市"],
  "柳州市": ["城中区", "鱼峰区", "柳南区", "柳北区", "柳江区", "柳城县", "鹿寨县", "融安县", "融水苗族自治县", "三江侗族自治县"],
  "桂林市": ["秀峰区", "叠彩区", "象山区", "七星区", "雁山区", "临桂区", "阳朔县", "灵川县", "全州县", "兴安县", "永福县", "龙胜各族自治县", "资源县", "平乐县", "荔浦市"],
  "海口市": ["秀英区", "龙华区", "琼山区", "美兰区"],
  "三亚市": ["海棠区", "吉阳区", "天涯区", "崖州区"],
  ...
  "氹仔岛": ["嘉模堂区"],
  "路环岛": ["圣方济各堂区"],
  "台北市": ["万华区", "大安区", "信义区", "中山区", "文山区", "士林区", "北投区", "松山区"],
  "新北市": ["板桥区", "三重区", "中和区", "永和区", "新庄区", "汐止区", "土城区", "淡水区"],
  "高雄市": ["新兴区", "前金区", "苓雅区", "盐埕区", "鼓山区", "旗津区", "前镇区", "三民区"]
};

// 备用兜底生成器：如果某些冷门城市没有录入，使用完全符合汉语政区命名规范的高保真逻辑
export const getFallbackCounties = (cityName: string): string[] => {
  const cleanCity = cityName.replace("市", "").replace("地区", "").replace("自治州", "").replace("盟", "");
  
  // 对于自治州、地区、盟，县级多用“县”、“旗”或县级市，而地级市多用“区”、“县”
  if (cityName.endsWith("州") || cityName.endsWith("盟") || cityName.endsWith("地区")) {
    return [
      `${cleanCity}市`,
      `${cleanCity}县`,
      `新城县`,
